...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>JobOs Dashboard admin</title>
					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a href="datatable.html">All_customer</a></li>
								<li><a href="datatable.html">All_Posts</a></li>
							</ul>
						</li>
							<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-table"></span
								><span class="mtext">Provider</span>
							</a>
							<ul class="submenu">
						
								<li><a href="datatable.html">All_providers</a></li>
								<li><a href="datatable.html">All_Posts</a></li>
							</ul>
						</li>
						...
						<li>
							<div class="sidebar-small-cap">Admin Settings</div>
						</li>
						<li>
							<a href="javascript:;" class="dropdown-toggle">
